...
from qfast.native.sc import synthesize
...
class TestSCSynthesize ( tf.test.TestCase ):
    ...
    def test_sc_synthesize_invalid_type ( self ):
    ...
    def test_sc_synthesize_invalid_value ( self ):
    ...
    def test_sc_synthesize_valid ( self ):
